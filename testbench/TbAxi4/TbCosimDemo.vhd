--
--  File Name:         TbCosimDemo.vhd
--  Design Unit Name:  TbCosimDemo
...
--
--  Description:
--      Co-simulation demo with image processing
--
--
--  Developed by:
...
end entity TbCosimDemo ;

architecture TestHarness of TbCosimDemo is
...
begin
  ...
  ------------------------------------------------------------
  -- AXI4 behavioral memory model VC
  ------------------------------------------------------------
  Memory_1 : Axi4Memory
  port map (
    -- Globals
  ...
  ------------------------------------------------------------
  -- Test control component to drive the logic
  ------------------------------------------------------------
  TestCtrl_1 : TestCtrl
  generic map (
